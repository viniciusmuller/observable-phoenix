defmodule ObservableTodolist.PromEx do
  @moduledoc """
  ...
  use PromEx, otp_app: :observable_todolist
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: ObservableTodolistWeb.Router, endpoint: ObservableTodolistWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
      ...
      # ObservableTodolist.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:observable_todolist, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
