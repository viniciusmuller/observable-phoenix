defmodule ObservableTodolistWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ObservableTodolistWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ObservableTodolistWeb.Gettext, "errors", msg, opts)
    end
  end
